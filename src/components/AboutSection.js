    ...
    return (
        ...
        <Container fluid
         >
            ...
            <div className="row" style={{backgroundColor:"pink"}}>{/* style={{backgroundColor:"red"}}style={{backgroundColor:"blue"}},height:"100vh" backgroundColor:"green",style={{backgroundColor:"pink"}}style={{backgroundColor:"yellow"}} */}
                            
                <div className="col-lg-7 col-md-12  d-flex align-items-center justify-content-start" >
                ...
                <div className="col-lg-5 col-md-12  d-flex justify-content-xs-center justify-content-lg-center align-items-center" style={{maxHeight: '100vh'}} >
                    <WomanImage />
                </div>
